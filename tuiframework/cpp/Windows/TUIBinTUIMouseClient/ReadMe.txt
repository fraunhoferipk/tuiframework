========================================================================
    KONSOLENANWENDUNG: TUIBinTUIMouseClient-Projektübersicht
========================================================================

Diese TUIBinTUIMouseClient-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Die Datei enthält eine Zusammenfassung des Inhalts der Dateien,
aus denen die TUIBinTUIMouseClient-Anwendung besteht.


TUIBinTUIMouseClient.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    mit dem Namen TUIBinTUIMouseClient.pch sowie eine vorkompilierte 
