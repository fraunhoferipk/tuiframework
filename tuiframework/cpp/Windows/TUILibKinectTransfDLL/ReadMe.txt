========================================================================
    DYNAMIC LINK LIBRARY: TUILibKinectTransfDLL-Projektübersicht
========================================================================

Diese TUILibKinectTransfDLL-DLL wurde vom Anwendungs-Assistenten für Sie 
erstellt.

Die Datei enthält eine Zusammenfassung des Inhalts der Dateien,
aus denen die TUILibKinectTransfDLL-Anwendung besteht.


TUILibKinectTransfDLL.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    mit dem Namen TUILibKinectTransfDLL.pch sowie eine vorkompilierte 
