========================================================================
    KONSOLENANWENDUNG: SupercolliderDLLTest-Projektübersicht
========================================================================

Diese SupercolliderDLLTest-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre SupercolliderDLLTest-Anwendung besteht.


SupercolliderDLLTest.vcxproj
...
SupercolliderDLLTest.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "SupercolliderDLLTest.pch und eine 
