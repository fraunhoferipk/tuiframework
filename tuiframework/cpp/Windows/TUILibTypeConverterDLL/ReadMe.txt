========================================================================
    DYNAMIC LINK LIBRARY: TUILibTypeConverterDLL-Projektübersicht
========================================================================

Diese TUILibTypeConverterDLL-DLL wurde vom Anwendungs-Assistenten für Sie 
erstellt.

Die Datei enthält eine Zusammenfassung des Inhalts der Dateien,
aus denen die TUILibTypeConverterDLL-Anwendung besteht.


TUILibTypeConverterDLL.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    mit dem Namen TUILibTypeConverterDLL.pch sowie eine vorkompilierte 
