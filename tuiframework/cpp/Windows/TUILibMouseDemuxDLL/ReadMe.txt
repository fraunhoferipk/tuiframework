========================================================================
    DYNAMIC LINK LIBRARY: TUILibMouseDemuxDLL-Projektübersicht
========================================================================

Diese TUILibMouseDemuxDLL-DLL wurde vom Anwendungs-Assistenten für Sie 
erstellt.

Die Datei enthält eine Zusammenfassung des Inhalts der Dateien,
aus denen die TUILibMouseDemuxDLL-Anwendung besteht.


TUILibMouseDemuxDLL.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    mit dem Namen TUILibMouseDemuxDLL.pch sowie eine vorkompilierte 
