========================================================================
    KONSOLENANWENDUNG: TUIBinTUIServer2-Projektübersicht
========================================================================

Diese TUIBinTUIServer2-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Die Datei enthält eine Zusammenfassung des Inhalts der Dateien,
aus denen die TUIBinTUIServer2-Anwendung besteht.


TUIBinTUIServer2.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    mit dem Namen TUIBinTUIServer2.pch sowie eine vorkompilierte 
