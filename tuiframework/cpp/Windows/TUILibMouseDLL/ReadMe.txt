========================================================================
    DYNAMIC LINK LIBRARY: TUILibMouseDLL-Projektübersicht
========================================================================

Diese TUILibMouseDLL-DLL wurde vom Anwendungs-Assistenten für Sie 
erstellt.

Die Datei enthält eine Zusammenfassung des Inhalts der Dateien,
aus denen die TUILibMouseDLL-Anwendung besteht.


TUILibMouseDLL.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    mit dem Namen TUILibMouseDLL.pch sowie eine vorkompilierte 
