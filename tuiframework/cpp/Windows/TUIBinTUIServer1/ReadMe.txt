========================================================================
    KONSOLENANWENDUNG: TUIBinTUIServer1-Projektübersicht
========================================================================

Diese TUIBinTUIServer1-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Die Datei enthält eine Zusammenfassung des Inhalts der Dateien,
aus denen die TUIBinTUIServer1-Anwendung besteht.


TUIBinTUIServer1.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    mit dem Namen TUIBinTUIServer1.pch sowie eine vorkompilierte 
