========================================================================
    KONSOLENANWENDUNG: KinectServer-Projektübersicht
========================================================================

Diese KinectServer-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Die Datei enthält eine Zusammenfassung des Inhalts der Dateien,
aus denen die KinectServer-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    ...
    mit dem Namen KinectServer.pch sowie eine vorkompilierte 
