========================================================================
    KONSOLENANWENDUNG: TUIBinTUIClient2-Projektübersicht
========================================================================

Diese TUIBinTUIClient2-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Die Datei enthält eine Zusammenfassung des Inhalts der Dateien,
aus denen die TUIBinTUIClient2-Anwendung besteht.


TUIBinTUIClient2.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    mit dem Namen TUIBinTUIClient2.pch sowie eine vorkompilierte 
