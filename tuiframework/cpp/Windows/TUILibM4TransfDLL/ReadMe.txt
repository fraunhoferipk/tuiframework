========================================================================
    DYNAMIC LINK LIBRARY: TUILibM4TransfDLL-Projektübersicht
========================================================================

Diese TUILibM4TransfDLL-DLL wurde vom Anwendungs-Assistenten für Sie 
erstellt.

Die Datei enthält eine Zusammenfassung des Inhalts der Dateien,
aus denen die TUILibM4TransfDLL-Anwendung besteht.


TUILibM4TransfDLL.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    mit dem Namen TUILibM4TransfDLL.pch sowie eine vorkompilierte 
