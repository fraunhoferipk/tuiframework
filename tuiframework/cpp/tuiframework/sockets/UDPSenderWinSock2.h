...
#ifndef _tuiframework_UDPSenderWinSock2_h_
#define _tuiframework_UDPSenderWinSock2_h_
 ...
 *  \date 2010-2012
 */
class UDPSenderWinSock2 {
public:
    UDPSenderWinSock2(IHostMsgSource & hostMsgSource);
    virtual ~UDPSenderWinSock2();
