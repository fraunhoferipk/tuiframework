...
/**
 *  Provides a multicast listener (windows version)
 *
 *  \author Oliver Belaifa
 *  \date 2010-2012
 */
class MulticastListenerWinSock2 {
public:
    MulticastListenerWinSock2(ISerializedDataSink & serializedDataSink);
    virtual ~MulticastListenerWinSock2();
