...
#ifndef _tuiframework_UDPReceiverWinSock2_h_
#define _tuiframework_UDPReceiverWinSock2_h_
 ...
 *  \date 2010-2012
 */
class UDPReceiverWinSock2 {
public:
    UDPReceiverWinSock2(ISerializedDataSink & serializedDataSink);
    virtual ~UDPReceiverWinSock2();
