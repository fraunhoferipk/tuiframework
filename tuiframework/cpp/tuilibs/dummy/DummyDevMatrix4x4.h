...
#ifndef _tuidevices_DummyDevMatrix4x4_h_
#define _tuidevices_DummyDevMatrix4x4_h_
...
class DummyDevMatrix4x4  : public tuiframework::IDevice, public tuiframework::IEventSink {
public:
    static IDevice * createFunction(void * arg);
    static std::string getDeviceName();

    DummyDevMatrix4x4(const tuiframework::DeviceConfig & deviceConfig);
    virtual ~DummyDevMatrix4x4();
