...
#ifndef _tuidevices_DummyDevTracker_h_
#define _tuidevices_DummyDevTracker_h_
...
class DummyDevTracker  : public tuiframework::IDevice, public tuiframework::IEventSink {
public:
    static IDevice * createFunction(void * arg);
    static std::string getDeviceName();

    DummyDevTracker(const tuiframework::DeviceConfig & deviceConfig);
    virtual ~DummyDevTracker();
