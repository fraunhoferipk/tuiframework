...
#ifndef _tuidevices_DummyDevMatrix4_h_
#define _tuidevices_DummyDevMatrix4_h_
...
class DummyDevMatrix4  : public tuiframework::IDevice, public tuiframework::IEventSink {
public:
    static IDevice * createFunction(void * arg);
    static std::string getDeviceName();

    DummyDevMatrix4(const tuiframework::DeviceConfig & deviceConfig);
    virtual ~DummyDevMatrix4();
