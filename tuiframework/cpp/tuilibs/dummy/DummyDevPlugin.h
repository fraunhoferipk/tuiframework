...
#ifndef _DummyDevicePlugin_h_
#define _DummyDevicePlugin_h_
...
namespace tuiframework {
    ...
    IDevice * soNewDeviceInstance(const std::string & deviceTypeName, tuiframework::DeviceConfig & deviceConfig);
    void soDeleteDeviceInstance(tuiframework::IDevice * device);
}
}
