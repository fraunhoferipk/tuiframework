...
#ifndef _tuiframework_Matrix4GetTranslationMSP_h_
#define _tuiframework_Matrix4GetTranslationMSP_h_
...
/**
 *  Matrix4GetTranslationMSP
 *
 *  \author Oliver Belaifa
 *  \date 2013
 */ 
class Matrix4GetTranslationMSP : public IMSP {
public:
    static IMSP * createFunction(void * arg);
    static const std::string & getMSPTypeName();

    Matrix4GetTranslationMSP(const MSPConfig & config);
    virtual ~Matrix4GetTranslationMSP();
...
protected:
    ...
    EventDelegateNC<Matrix4Event, Matrix4GetTranslationMSP> eventDelegateM;    
    EventDelegateNC<PackedMatrix4Event, Matrix4GetTranslationMSP> eventDelegateMP;
