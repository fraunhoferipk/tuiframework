...
#ifndef _tuiframework_Vector4DuplicateMSP_h_
#define _tuiframework_Vector4DuplicateMSP_h_
 ...
 *  \date 2013
 */ 
class Vector4DuplicateMSP : public IMSP {
public:
    static IMSP * createFunction(void * arg);
    static const std::string & getMSPTypeName();

    Vector4DuplicateMSP(const MSPConfig & config);
    virtual ~Vector4DuplicateMSP();
...
protected:
    ...
    EventDelegateNC<Vector4Event, Vector4DuplicateMSP> eventDelegateA;
