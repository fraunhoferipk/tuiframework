...
#ifndef _tuiframework_Matrix4DuplicateMSP_h_
#define _tuiframework_Matrix4DuplicateMSP_h_
 ...
 *  \date 2013
 */ 
class Matrix4DuplicateMSP : public IMSP {
public:
    static IMSP * createFunction(void * arg);
    static const std::string & getMSPTypeName();

    Matrix4DuplicateMSP(const MSPConfig & config);
    virtual ~Matrix4DuplicateMSP();
...
protected:
    ...
    EventDelegateNC<Matrix4Event, Matrix4DuplicateMSP> eventDelegateA;
