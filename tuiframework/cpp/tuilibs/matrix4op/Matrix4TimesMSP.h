...
#ifndef _tuiframework_Matrix4TimesMSP_h_
#define _tuiframework_Matrix4TimesMSP_h_
 ...
 *  \date 2013
 */ 
class Matrix4TimesMSP : public IMSP {
public:
    static IMSP * createFunction(void * arg);
    static const std::string & getMSPTypeName();

    Matrix4TimesMSP(const MSPConfig & config);
    virtual ~Matrix4TimesMSP();
...
protected:
    ...
    EventDelegateNC<Matrix4Event, Matrix4TimesMSP> eventDelegateA;
    EventDelegateNC<Matrix4Event, Matrix4TimesMSP> eventDelegateB;
    
    EventDelegateNC<PackedMatrix4Event, Matrix4TimesMSP> eventDelegateBP;
