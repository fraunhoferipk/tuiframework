...
#ifndef _tuiframework_Matrix4PackedDuplicateMSP_h_
#define _tuiframework_Matrix4PackedDuplicateMSP_h_
...
/**
 *  Matrix4PackedDuplicateMSP
 *
 *  \author Oliver Belaifa
 *  \date 2013
 */ 
class Matrix4PackedDuplicateMSP : public IMSP {
public:
    static IMSP * createFunction(void * arg);
    static const std::string & getMSPTypeName();

    Matrix4PackedDuplicateMSP(const MSPConfig & config);
    virtual ~Matrix4PackedDuplicateMSP();
...
protected:
    ...
    EventDelegateNC<PackedMatrix4Event, Matrix4PackedDuplicateMSP> eventDelegateAP;
