...
void soInitPlugin() {
    DeviceFactorySingleton::getInstance()->registerCreateFunction(MouseDev::getDeviceName(), MouseDev::createFunction);
    deviceTypeNameVector.push_back(MouseDev::getDeviceName());
}
...
void soDeviceRegistration(IDeviceFactory * deviceFactory) {
    deviceFactory->registerCreateFunction(MouseDev::getDeviceName(), MouseDev::createFunction);
}
